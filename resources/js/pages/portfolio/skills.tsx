...
export default function Skills({ skills }: any) {
    return (
        <PortfolioLayout title="Skills">
            <section id="skills" className="relative z-10 py-24 bg-transparent min-h-[calc(100vh-80px)] transition-colors duration-300">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        {skills?.length > 0 ? (
                            skills.map((skill: any) => {
                                // Try to match by icon key first, then by name
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="w-full bg-gray-100 dark:bg-gray-800 h-1 rounded-full mt-3 transition-colors">
                                            <div
                                                className="bg-[#ff7700] h-full rounded-full transition-all duration-700"
